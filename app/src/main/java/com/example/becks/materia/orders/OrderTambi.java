...
public class OrderTambi extends AppCompatActivity {
    ...
    private int counter=1,sp_phone2,userID;
    private String fname,sp_location,sp_name,sp_phone;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_order_tambi);
