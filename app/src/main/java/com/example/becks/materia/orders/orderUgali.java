...
public class orderUgali extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_ugali);
    ...
    public void Add(View v){
        ...
        txt_total.setText(String.valueOf(2000*counter));
        counter++;
...
//    }
        ...
        protected String doInBackground(String... params) {
            String url_order = "http://foodly.pe.hu/api/appsripts/orderingUgali0.php"; // url for register users information
