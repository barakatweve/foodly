...
public class walikuku extends AppCompatActivity {
...
//    }
        ...
        protected String doInBackground(String... params) {
            String url_order = "http://foodly.pe.hu/api/appsripts/orderingWaliKuku1.php"; // url for register users information
