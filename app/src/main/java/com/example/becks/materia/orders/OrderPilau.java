package com.example.becks.materia.orders;
...
public class OrderPilau extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_pilau);
...
//    }
        ...
        protected String doInBackground(String... params) {
            String url_order = "http://foodly.pe.hu/api/appsripts/orderingPilau0.php"; // url for register users information
                ...
                try {
                    ...
                    try {
                        ...
                        String data = URLEncoder.encode("phonenumber", "UTF-8") + "=" + URLEncoder.encode(String.valueOf(phone), "UTF-8") + "&" +
                                ...
                                URLEncoder.encode("fname", "UTF-8") + "=" + URLEncoder.encode(fname, "UTF-8") + "&" +
                                URLEncoder.encode("userID", "UTF-8") + "=" + URLEncoder.encode(String.valueOf(userID), "UTF-8"); bw.write(data);
                        bw.flush();
                        bw.close();
                        os.close();
