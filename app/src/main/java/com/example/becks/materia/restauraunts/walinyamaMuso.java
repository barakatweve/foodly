...
public class walinyamaMuso extends AppCompatActivity {
...
//    }
        ...
        protected String doInBackground(String... params) {
            String url_order = "http://foodly.pe.hu/api/appsripts/orderingWalinyama2.php"; // url for register users information
