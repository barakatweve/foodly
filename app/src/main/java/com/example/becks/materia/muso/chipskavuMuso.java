...
public class chipskavuMuso extends AppCompatActivity {
...
//    }
        ...
        protected String doInBackground(String... params) {
            String url_order = "http://myfirstdatabase.esy.es/orderingChips2.php"; // url for register users information
