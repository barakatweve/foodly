...
import com.example.becks.materia.muso.musoGetSet;
 ...
 */
    ...
    public class cafelistAdapter extends ArrayAdapter {
        List lists = new ArrayList();


        public cafelistAdapter(Context context, int resource) {

            super(context, resource);
        }

        public void add(cafeGetSet object) {
            super.add(object);
            lists.add(object);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            cafeGetSet co= (cafeGetSet) getItem(position);
