...
public class walikukucafe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),chips.class));
            }
        });
...
//    }
        ...
        protected String doInBackground(String... params) {
            String url_order = "http://foodly.pe.hu/api/appsripts/orderingWaliakuku3.php"; // url for register users information
